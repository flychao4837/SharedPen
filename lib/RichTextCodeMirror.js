    ...
    class RichTextCodeMirror {
        ...
        insertTable(tag, placeholder) {
            ...
            var cb = function() {
                var dialog = document.getElementById('overlay');
                dialog.style.visibility = "hidden";
                var columns = document.getElementById('column-num').value;
                var rows = document.getElementById('row-num').value;
            ...
            var columnInput = Utils.elt('input', null, {
                'class': 'insertimage-dialog-input',
                'id': 'column-num',
                'type': 'text',
                'placeholder': 'input column number',
                'autofocus': 'autofocus'
            });

            var rowInput = Utils.elt('input', null, {
                'class': 'insertimage-dialog-input',
                'id': 'row-num',
                'type': 'text',
                'placeholder': 'input row number',
                'autofocus': 'autofocus'
            });

            var submit = Utils.elt('a', '提交', {
                'class': 'insertimage-btn',
                'id': 'submitbtn'
            });
            Utils.on(submit, 'click', Utils.stopEventAnd(cb));

            var cancel = Utils.elt('a', '取消', {
                'class': 'insertimage-btn'
            });
            Utils.on(cancel, 'click', Utils.stopEventAnd(hideDialog));
            ...
            var div = Utils.elt('div', [rowInput,columnInput, buttonsdiv], {
                'class': 'insertimage-dialog-div'
            });
            var dialog = Utils.elt('div', [div], {
                'class': 'insertimage-dialog',
